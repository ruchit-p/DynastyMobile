          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                Based on your file type ({fileType}) and size ({StorageUtils.formatFileSize(fileSize || 0)}), 
                we recommend <strong>{PROVIDER_INFO.find(p => p.provider === recommended)?.name}</strong> 
